  ...
  return (
      <div className='w-full bg-white p-5 min-h-screen'>
        <div className='flex justify-between mb-4'>
            <div className='text-xl font-medium text-[#191A1B]'>Categories</div>
            ...
            <div className='flex flex-col items-center justify-center py-16 px-8 bg-white border border-[#EAEAEA] rounded-lg'>
              ...
              <div className='text-center'>
                <h3 className='text-lg font-semibold text-[#191A1B] mb-2'>
                  {isSearchActive ? 'No Categories Found' : 'No Categories Available'}
                </h3>
                <p className='text-sm text-[#545659] mb-6 max-w-md'>
                  {isSearchActive 
                    ? `No Categoreismatch your search "${searchText}". Try a different search term.`
                    : 'You haven\'t added any Categoreis yet. Create your first SKU to start managing your product inventory.'
                  }
                </p>
