...
const VerifyPassword: React.FC<Props> = ({ onContinue, onForgotPassword }) => {
    ...
    <div className='flex justify-center items-center w-screen h-screen bg-[#A3A3A4]'>
      <div className='bg-white rounded-lg shadow-md w-[480px]'>
        ...
        <div className='flex flex-col items-center my-4 gap-1.5'>
            <div className='text-[#191A1B] text-lg font-semibold'>Verify Your Password</div>
            <div className='text-[#545659] text-sm '>Enter your current password to continue</div>
        </div>
